...
_BASE_STRINGS = {
    ...
    'idx_song_acoustid_rate_limited': '⚠️ AcoustID rate limit reached',
    'idx_song_acoustid_network': '⚠️ AcoustID unreachable',
    'idx_song_acoustid_error': '⚠️ AcoustID error (code {code})',
    ...
    'cfg_songstats_acoustid_heading': 'AcoustID cloud fallback (phase 2)',
    'cfg_songstats_acoustid_key': 'API key configured',
    'cfg_songstats_yes': 'yes',
    'cfg_songstats_no': 'no',
    'cfg_songstats_acoustid_laststatus': 'Last status',
    'cfg_songstats_acoustid_status_none': '– (no attempt yet)',
    'cfg_songstats_acoustid_status_ok': '✅ OK',
    'cfg_songstats_acoustid_status_rate_limited': '⚠️ Rate limit reached',
    'cfg_songstats_acoustid_status_network': '⚠️ Unreachable',
    'cfg_songstats_acoustid_status_error': '⚠️ Error (code {code})',
    'cfg_songstats_acoustid_today': 'Requests today',
    'cfg_songstats_acoustid_week': 'Requests last 7 days',
    'cfg_songstats_acoustid_total': 'Requests total',
    'cfg_songstats_acoustid_since': 'since',
    'cfg_songstats_acoustid_outcomes': 'Outcomes (hit/no match/rate limit/error/network)',
    'cfg_songstats_acoustid_successrate': 'Success rate',
    'cfg_songstats_acoustid_hint': 'AcoustID is free (fair-use limit of 3 requests/second).',
    'cfg_songstats_acoustid_hint_legacy': 'AcoustID is free (fair-use limit of 3 requests/second). {legacy} request(s) from before the switch from AudD to AcoustID are excluded from these numbers.',
