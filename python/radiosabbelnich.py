...
# STREAM_READ_TIMEOUT lebt seit 2026-08-21 in stream_source.py (siehe Import
# oben) -- gehört zu StreamSource.read_window(), nicht zur Hauptloop-Konfiguration.
...
# StreamSource lebt seit 2026-08-21 in stream_source.py (siehe Import oben)
# -- ad_skip_prebuffer.py braucht dieselbe Klasse, ohne radiosabbelnich.py
# importieren zu müssen (Zirkelimport-Vermeidung, siehe dortiger Docstring).
